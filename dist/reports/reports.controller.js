...
let ReportsController = class ReportsController {
    ...
    async getVatReport(user, from, to) {
        if (!from || !to) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get VAT report for date range' }),
    (0, swagger_1.ApiQuery)({ name: 'from', example: '2025-01-01' }),
    (0, swagger_1.ApiQuery)({ name: 'to', example: '2025-12-31' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'VAT report generated' }),
