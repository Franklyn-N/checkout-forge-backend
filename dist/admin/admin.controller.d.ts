...
export declare class AdminController {
    ...
    createPrice(req: any, dto: CreatePriceDto): Promise<{
        type: import(".prisma/client").$Enums.PriceType;
        id: string;
        isActive: boolean;
        createdAt: Date;
    ...
    updatePrice(req: any, id: string, dto: UpdatePriceDto): Promise<{
        type: import(".prisma/client").$Enums.PriceType;
        id: string;
        isActive: boolean;
        createdAt: Date;
    ...
    processRefund(req: any, dto: ProcessRefundDto): Promise<{
        id: string;
        createdAt: Date;
        amount: number;
        orderId: string;
