...
const upload_template_dto_1 = require("./upload-template.dto");
class QueryTemplatesDto {
}
exports.QueryTemplatesDto = QueryTemplatesDto;
__decorate([
    (0, swagger_1.ApiProperty)({ enum: upload_template_dto_1.TemplateCategory, required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(upload_template_dto_1.TemplateCategory),
