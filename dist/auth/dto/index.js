...
exports.LoginDto = exports.SignupDto = exports.UserRole = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'demo-tenant' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SignupDto.prototype, "tenantId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: UserRole, default: UserRole.ADMIN }),
    (0, class_validator_1.IsOptional)(),
